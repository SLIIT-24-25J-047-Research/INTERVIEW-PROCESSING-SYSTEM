...
const mockQuestions: Question[] = [
  ...
  },
  {
    ...
    description:
      "Fill in the blanks to complete this custom React hook that manages a counter with increment and decrement functions.",
  ...
  },
  {
    ...
    description:
      "Arrange these React class component lifecycle methods in the order they are called during component mounting.",
  ...
  },
  {
    ...
    title: "Binary Search",
    description:
      "Implement a binary search function that returns the index of the target element in a sorted array. Return -1 if the target is not found.",
